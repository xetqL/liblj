...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libliblj.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libliblj.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libliblj.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libliblj.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libliblj.a
...
${OBJECTDIR}/nbody_bin_io.o: nbody_bin_io.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbody_bin_io.o nbody_bin_io.cpp

${OBJECTDIR}/params.o: params.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/params.o params.cpp
...
${TESTDIR}/tests/atomic_cells_tests_t.o: tests/atomic_cells_tests_t.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/atomic_cells_tests_t.o tests/atomic_cells_tests_t.cpp


${TESTDIR}/tests/atomic_cells_testsrunner.o: tests/atomic_cells_testsrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/atomic_cells_testsrunner.o tests/atomic_cells_testsrunner.cpp


${TESTDIR}/tests/matrix_tests_t.o: tests/matrix_tests_t.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/matrix_tests_t.o tests/matrix_tests_t.cpp


${TESTDIR}/tests/matrix_testsrunner.o: tests/matrix_testsrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/matrix_testsrunner.o tests/matrix_testsrunner.cpp
...
${OBJECTDIR}/common_nomain.o: ${OBJECTDIR}/common.o common.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common_nomain.o common.cpp;\
	else  \
...
${OBJECTDIR}/linkedlist_nomain.o: ${OBJECTDIR}/linkedlist.o linkedlist.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/linkedlist_nomain.o linkedlist.cpp;\
	else  \
...
${OBJECTDIR}/nbody_bin_io_nomain.o: ${OBJECTDIR}/nbody_bin_io.o nbody_bin_io.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nbody_bin_io_nomain.o nbody_bin_io.cpp;\
	else  \
...
${OBJECTDIR}/params_nomain.o: ${OBJECTDIR}/params.o params.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/params_nomain.o params.cpp;\
	else  \
...
${OBJECTDIR}/tests/tests_nomain.o: ${OBJECTDIR}/tests/tests.o tests/tests.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/tests_nomain.o tests/tests.cpp;\
	else  \
